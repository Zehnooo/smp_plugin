...
public enum RelicType {
    ...
    EMBER_BLADE(Material.NETHERITE_SWORD, "Surtr's Sword", "Right click grants the user temporary fire resistance.", PotionEffectType.FIRE_RESISTANCE, 20 * 6, 1, RelicTrigger.RIGHT_CLICK, RelicTarget.SELF),
    WIND_SPEAR(Material.NETHERITE_SPEAR, "Aeglos", "Right click grants the user temporary speed.", PotionEffectType.SPEED, 20 * 6, 1, RelicTrigger.RIGHT_CLICK, RelicTarget.SELF),
